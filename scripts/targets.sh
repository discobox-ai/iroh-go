...
#   native  Plain cargo, on a host of that OS. Used for macOS and Windows;
#           see build-libs.sh for why neither cross-compiles in practice.
IROH_TARGETS="
...
windows_amd64|x86_64-pc-windows-msvc|native
windows_arm64|aarch64-pc-windows-msvc|native

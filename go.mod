...
require (
	github.com/discobox-ai/iroh-go/libs/darwin_amd64 v0.4.0
	github.com/discobox-ai/iroh-go/libs/darwin_arm64 v0.4.0
	github.com/discobox-ai/iroh-go/libs/linux_amd64 v0.4.0
	github.com/discobox-ai/iroh-go/libs/linux_amd64_musl v0.4.0
	github.com/discobox-ai/iroh-go/libs/linux_arm64 v0.4.0
	github.com/discobox-ai/iroh-go/libs/linux_arm64_musl v0.4.0
	github.com/discobox-ai/iroh-go/libs/windows_amd64 v0.4.0
	github.com/discobox-ai/iroh-go/libs/windows_arm64 v0.4.0
